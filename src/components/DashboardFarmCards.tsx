...
function DashboardFarmRow({
  ...
  return (
    <div className={`relative overflow-hidden ${isLast ? "" : "border-b border-stone-100"}`}>
      <div
        className="absolute inset-y-0 right-0 flex w-[100px] items-center justify-center bg-stone-600"
