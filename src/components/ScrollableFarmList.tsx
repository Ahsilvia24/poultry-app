...
export const VISIBLE_FARM_ROWS = 6;

/**
 * Caps a dashboard farm list to ~6 rows. Extra items scroll inside the tile
  ...
  return (
    <div
      className={cn(
        ...
        "max-h-[calc(1.25rem*6+0.375rem*5)] overflow-y-auto overscroll-contain",
