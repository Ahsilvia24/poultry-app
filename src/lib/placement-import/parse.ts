...
/** Walk tokens — handles pdf.js one-cell-per-line output; partial rows allowed. */
...
/** Parse spreadsheet rows (CSV/XLSX already converted to string[][]). Partial columns allowed. */
